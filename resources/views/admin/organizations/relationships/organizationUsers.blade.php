    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-organizationUsers">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($users as $key => $user)
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $user->featured ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-organizationUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
