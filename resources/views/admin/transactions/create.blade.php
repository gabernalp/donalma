    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transactions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state_pol') ? 'is-invalid' : '' }}" type="text" name="state_pol" id="state_pol" value="{{ old('state_pol', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('response_code_pol') ? 'is-invalid' : '' }}" type="text" name="response_code_pol" id="response_code_pol" value="{{ old('response_code_pol', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_sale') ? 'is-invalid' : '' }}" type="text" name="reference_sale" id="reference_sale" value="{{ old('reference_sale', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_pol') ? 'is-invalid' : '' }}" type="text" name="reference_pol" id="reference_pol" value="{{ old('reference_pol', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_method_type') ? 'is-invalid' : '' }}" type="text" name="payment_method_type" id="payment_method_type" value="{{ old('payment_method_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('installments_number') ? 'is-invalid' : '' }}" type="text" name="installments_number" id="installments_number" value="{{ old('installments_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_buyer') ? 'is-invalid' : '' }}" type="text" name="email_buyer" id="email_buyer" value="{{ old('email_buyer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cus') ? 'is-invalid' : '' }}" type="text" name="cus" id="cus" value="{{ old('cus', '') }}">
                @if($errors->has('cus'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pse_bank') ? 'is-invalid' : '' }}" type="text" name="pse_bank" id="pse_bank" value="{{ old('pse_bank', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_number_ach') ? 'is-invalid' : '' }}" type="text" name="account_number_ach" id="account_number_ach" value="{{ old('account_number_ach', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_type_ach') ? 'is-invalid' : '' }}" type="text" name="account_type_ach" id="account_type_ach" value="{{ old('account_type_ach', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('administrative_fee') ? 'is-invalid' : '' }}" type="text" name="administrative_fee" id="administrative_fee" value="{{ old('administrative_fee', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('administrative_fee_base') ? 'is-invalid' : '' }}" type="text" name="administrative_fee_base" id="administrative_fee_base" value="{{ old('administrative_fee_base', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('administrative_fee_tax') ? 'is-invalid' : '' }}" type="text" name="administrative_fee_tax" id="administrative_fee_tax" value="{{ old('administrative_fee_tax', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('authorization_code') ? 'is-invalid' : '' }}" type="text" name="authorization_code" id="authorization_code" value="{{ old('authorization_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('billing_country') ? 'is-invalid' : '' }}" type="text" name="billing_country" id="billing_country" value="{{ old('billing_country', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commision_pol') ? 'is-invalid' : '' }}" type="text" name="commision_pol" id="commision_pol" value="{{ old('commision_pol', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commision_pol_currency') ? 'is-invalid' : '' }}" type="text" name="commision_pol_currency" id="commision_pol_currency" value="{{ old('commision_pol_currency', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_number') ? 'is-invalid' : '' }}" type="text" name="customer_number" id="customer_number" value="{{ old('customer_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_methodid') ? 'is-invalid' : '' }}" type="text" name="payment_methodid" id="payment_methodid" value="{{ old('payment_methodid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_request_state') ? 'is-invalid' : '' }}" type="text" name="payment_request_state" id="payment_request_state" value="{{ old('payment_request_state', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pse_reference_1') ? 'is-invalid' : '' }}" type="text" name="pse_reference_1" id="pse_reference_1" value="{{ old('pse_reference_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pse_reference_2') ? 'is-invalid' : '' }}" type="text" name="pse_reference_2" id="pse_reference_2" value="{{ old('pse_reference_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pse_reference_3') ? 'is-invalid' : '' }}" type="text" name="pse_reference_3" id="pse_reference_3" value="{{ old('pse_reference_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('response_message_pol') ? 'is-invalid' : '' }}" type="text" name="response_message_pol" id="response_message_pol" value="{{ old('response_message_pol', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transaction_bank') ? 'is-invalid' : '' }}" type="text" name="transaction_bank" id="transaction_bank" value="{{ old('transaction_bank', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_method_name') ? 'is-invalid' : '' }}" type="text" name="payment_method_name" id="payment_method_name" value="{{ old('payment_method_name', '') }}">
