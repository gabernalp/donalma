...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="organization_id">{{ trans('cruds.event.fields.organization') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.organization_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="featured">{{ trans('cruds.event.fields.featured') }}</label>
                <input class="form-control {{ $errors->has('featured') ? 'is-invalid' : '' }}" type="text" name="featured" id="featured" value="{{ old('featured', '') }}">
            ...
            <div class="form-group">
                <label for="file">{{ trans('cruds.event.fields.file') }}</label>
                <input class="form-control {{ $errors->has('file') ? 'is-invalid' : '' }}" type="text" name="file" id="file" value="{{ old('file', '') }}">
                @if($errors->has('file'))
                    <span class="text-danger">{{ $errors->first('file') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.file_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="comments">{{ trans('cruds.event.fields.comments') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.event.fields.comments_helper') }}</span>
            </div>
            <div class="form-group">
