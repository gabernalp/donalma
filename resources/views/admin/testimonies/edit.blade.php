    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.testimonies.update", [$testimony->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $testimony->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('testimonial_text') ? 'is-invalid' : '' }}" name="testimonial_text" id="testimonial_text">{{ old('testimonial_text', $testimony->testimonial_text) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" {{ $testimony->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comments') ? 'is-invalid' : '' }}" type="text" name="comments" id="comments" value="{{ old('comments', $testimony->comments) }}">
